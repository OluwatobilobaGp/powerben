...
<body class="bg-gradient-to-r from-blue-600 to-blue-900 min-h-screen pt-10 md:pt-20 pb-6 px-2 md:px-10">
    ...
    <main class="bg-white rounded-3xl shadow-2xl p-5">
        ...
        <section class="flex items-center justify-between">
            <a href="yandev" class="rounded-r-full rounded-tl-full bg-gradient-to-r from-blue-600 to-blue-900 text-white font-bold py-4 px-5 hover:text-cyan-400 hover:shadow-2xl transition duration-500">
                <h1 class="font-bold capitalize ">Yandev Dashborad</h1>
            </a>
        ...
        <section class="justify-center mx-auto my-11">
                        ...
                        <form action="javascript:void(0)" method="" id="ipreadform" class="flex flex-col mx-auto w-full ">
                            ...
                            <div class="flex flex-col w-full px-5 mx-auto lg:flex-row lg:px-2 lg:space-x-5 md:justify-between">
                                <div class="mb-2 pt-3 rounded-r-2xl w-full">
                                    ...
                                    <input type="text" id="ip_apir_station" name="ip_apir_station" readonly value="YANDEV" class="bg-gray-100 w-full rounded-r-2xl p-3 focus:outline-none border-b-4 border-gray focus:border-blue-600 transition duration-500">
                                </div>
                            </div>
            ...
            <div id="viewinputRead" class=" flex hidden p-6  px-30 rounded-lg  bg-white text-black right-6 top-20 z-100 shadow-2xl ">
                ...
                <table class="px-16 table  w-full border" id="ipreadTable">
                    <thead>
                        <tr class="flex justify-evenly capitalize font-black">
                            <td>station</td>
                            <td>load_date</td>
                            <td>hour</td>
                            <td>feeder</td>
                            <td>load reading</td>
                            <td>energy reading</td>
                        </tr>
                    </thead>
                    <tbody> </tbody>
                </table>
                    ...
                    <fieldset class="border-2 border-blue-600 w-full mx-auto md:w-1/2 pb-4 rounded-2xl px-5 ">
                        ...
                        <form action="javascript:void(0)" method="" id="ipoutagereading" class="flex flex-col mx-auto w-full ">
                            ...
                            <div class="flex flex-col w-full px-5 mx-auto lg:flex-row lg:px-2 lg:space-x-5 md:justify-between">
                                <div class="mb-2 pt-3 rounded-r-2xl w-full">
                                    <p class="flex space-x-2 font-bold"><label for="Load Date" class="block mb-2 ml-3 font-bold">Station</label><label for="hash" class="text-red-600"> *</label></p>
                                    <input type="text" id="ipout_apir_station" name="ipout_apir_station" readonly value="YANDEV" class="bg-gray-100 w-full rounded-r-2xl p-3 focus:outline-none border-b-4 border-gray focus:border-blue-600 transition duration-500">
                                </div>
                            </div>
            ...
            <div id="viewOutageRead" class=" flex hidden p-6  px-30 rounded-lg  bg-white text-black right-6 top-20 z-100 shadow-2xl ">
                ...
                <table class=" px-16 table  w-full border  ">
                    <thead>
                        <tr class="flex justify-evenly capitalize font-black">
                            <td>station</td>
                            <td>load_date</td>
...
<script>
    ...
    function fetchRecords(ip_apir_station, vw_ip_feeder_date, vw_ip_feeder) {

        $.ajax({
            url: 'vw-ip-save/' + ip_apir_station + '/' + vw_ip_feeder_date + '/' + vw_ip_feeder,
            method: 'get',
            dataType: 'json',
            success: function(response) {
                ...
                var len = 0;
                $('#ipreadTable tbody').empty(); // Empty tbody
                ...
                if (len > 0) {
                    ...
                    $("#ipreadTable tbody").append(tr_str);
                }
